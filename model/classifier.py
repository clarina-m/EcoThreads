...
class FashionDataset(Dataset):
    def __init__(self, dataset, transform=None, undersample=False, max_class_0_samples=8000):
        ...
        self.label_encoder.fit([sample[self.label_column] for sample in self.dataset])
    ...
    def undersample_data(self, dataset):
        #separate apparel class samples
        ...
        #undersample apparel class 0 to have 8000 samples
